...
export default function UserAttendeeComponent(props) {
...
UserAttendeeComponent.propTypes = {
  ...
  //  using shape so shows data as a JSON, but could be changed to use props
...
UserAttendeeComponent.defaultProps = {
  attendee: {
    firstName: 'John',
    lastName: 'Doe',
